(function () {
  ...
  function HomeController() {
    ...
    vm.skills_Mobile = ["Swift 3","Xcode","Core Data","Core Location","Apple Maps SDK","Facebook SDK","Google Maps API","Google Places API","Google Cloud Vision API","Alamofire"]

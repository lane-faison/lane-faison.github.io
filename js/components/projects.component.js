(function () {
  ...
  function ProjectsController() {
    ...
    vm.projects = [
      ...
      {title: 'Movie Ratings', description: 'The goal of this project was to create a site where the user can create, read, update, and delete movies from the database.', image_url:'/assets/images/logos-projects/americanSniper.jpg', project_url:'https://salty-chamber-44152.herokuapp.com/home.html'},
